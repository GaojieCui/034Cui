...
# 数据集路径
dataset_dir = r'D:\intership\DAY3\data_set\Images'  # 替换为你的数据集路径
train_dir = r'D:\intership\DAY3\data_set\images\train'  # 训练集输出路径
val_dir = r'D:\intership\DAY3\data_set\images\val'  # 验证集输出路径
